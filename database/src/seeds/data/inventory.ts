...
export const CATEGORY_IDS = {
  MEDICAMENTOS: "11111111-1111-1111-a111-111111111101",
  VACUNAS: "11111111-1111-1111-a111-111111111102",
  INSUMOS_QUIRURGICOS: "11111111-1111-1111-a111-111111111103",
  HIGIENE_CUIDADO: "11111111-1111-1111-a111-111111111104",
} as const

export const SUPPLIER_IDS = {
  VETLIFE: "11111111-1111-1111-a111-111111111201",
  ANIMALCARE: "11111111-1111-1111-a111-111111111202",
  PETHEALTH: "11111111-1111-1111-a111-111111111203",
} as const

export const PRODUCT_IDS = {
  AMOXICILINA: "11111111-1111-1111-a111-111111111301",
  MELOXICAM: "11111111-1111-1111-a111-111111111302",
  VACUNA_TRIPLE: "11111111-1111-1111-a111-111111111303",
  VACUNA_ANTIRRABICA: "11111111-1111-1111-a111-111111111304",
  GASAS: "11111111-1111-1111-a111-111111111305",
  GUANTES: "11111111-1111-1111-a111-111111111306",
  SHAMPOO: "11111111-1111-1111-a111-111111111307",
  CEPILLO: "11111111-1111-1111-a111-111111111308",
} as const

export const STOCK_IDS = {
  AMOXICILINA: "11111111-1111-1111-a111-111111111401",
  MELOXICAM: "11111111-1111-1111-a111-111111111402",
  VACUNA_TRIPLE: "11111111-1111-1111-a111-111111111403",
  VACUNA_ANTIRRABICA: "11111111-1111-1111-a111-111111111404",
  GASAS: "11111111-1111-1111-a111-111111111405",
  GUANTES: "11111111-1111-1111-a111-111111111406",
  SHAMPOO: "11111111-1111-1111-a111-111111111407",
  CEPILLO: "11111111-1111-1111-a111-111111111408",
} as const
...
export const productSeed: ProductSeed[] = [
  {
    ...
    code: "AMX-500",
    description:
      "Antibiótico de amplio espectro para infecciones bacterianas en perros y gatos",
    price: 35.0,
  ...
  },
  {
    ...
    code: "MLX-05",
    description:
      "Antiinflamatorio no esteroideo para control del dolor y la inflamación",
    price: 28.0,
    categoryId: CATEGORY_IDS.MEDICAMENTOS,
    supplierId: SUPPLIER_IDS.VETLIFE,
  },
  {
    ...
    code: "VTF-001",
    description:
      "Vacuna combinada contra panleucopenia, calicivirus y rinotraqueítis felina",
    price: 85.0,
  ...
  },
  {
    ...
    code: "GAS-10",
    description:
      "Gasas estériles de algodón para curaciones y procedimientos quirúrgicos",
    price: 12.5,
  ...
  },
  {
    ...
    code: "CDM-001",
    description:
      "Cepillo dental diseñado para la limpieza de dientes de perros y gatos",
    price: 18.0,
    categoryId: CATEGORY_IDS.HIGIENE_CUIDADO,
    supplierId: SUPPLIER_IDS.PETHEALTH,
  },

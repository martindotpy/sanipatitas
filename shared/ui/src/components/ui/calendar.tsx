...
const $month = atom<CalendarState["month"]>(
  new Date().getMonth() as CalendarState["month"]
)
const $year = atom<CalendarState["year"]>(new Date().getFullYear())

export const useCalendarMonth = () => [useStore($month), $month.set] as const
export const useCalendarYear = () => [useStore($year), $year.set] as const

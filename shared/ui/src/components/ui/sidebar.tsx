...
import {
  ...
  TooltipContent,
  TooltipTrigger,
} from "@sanipatitas/ui/components/ui/tooltip"
import { useIsMobile } from "@sanipatitas/ui/hooks/use-mobile"
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground z-200 w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
